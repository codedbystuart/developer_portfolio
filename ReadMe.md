...
<div align="center">
  ...
  <h3><b>Stuart Dambi Developer Portifolio</b></h3>
...
# 📖 Stuart Dambi Developer Portifolio <a name="about-project"></a>

<!-- > Describe your project in 1 or 2 sentences. -->

**Stuart Dambi Developer Portifolio** is a portifolio Website built with HTML and CSS, to display the previous 
work and experience of Dambi Stuart
...
```sh
  cd my-folder
  git clone git@github.com:codedbystuart/developer_portfolio.git
```
